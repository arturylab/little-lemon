...
return (
    <footer className="text-center px-20 py-5 mt-10 text-sm text-gray-600">
            <hr className="w-full mx-auto border-gray-300 mb-4" />
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
